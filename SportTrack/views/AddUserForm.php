...
<body>
      ...
      <form action="index.php?page=user_add" method="POST">
            ...
            <p> Date de naissance :
                  <input type="date" id="birthdate" name="birthdate"  min="1900-01-01" max=="<?= date('Y-m-d'); ?>" required />
            </p>
            ...
            <p> Taille (en centimètres) :
                  <input type="number" id="height" name ="height" max="250" min ="101" required />
            </p>


            <p> Poids (en kilogrammes) :
                  <input type="number" id="weight" name="weight" max="200" min="31" required />
            </p>
            ...
            <p> Mot de passe :
                  ...
                  <input type="password" id="password" name="password" pattern= "(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[&,é,@,_]).{8,}" />
            </p>
